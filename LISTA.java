...
// Declaración de la clase LISTA que extiende de JFrame
public class LISTA extends javax.swing.JFrame {
    ...
    public LISTA() {
        ...
        initComponents();
        // Establece la ubicación del formulario en el centro de la pantalla
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        this.toBack();// Envía el formulario hacia atrás, detrás de otras ventanas
        setVisible(false);// Establece la visibilidad del formulario como falso, es decir, lo oculta
        new MENU().toFront();// Crea una nueva instancia de la clase MENU y la coloca al frente
    ...
    public static void main(String args[]) {
         ...
         */
        // Recorre la lista de aspectos instalados en el sistema
        try {
            for (javax.swing.UIManager.LookAndFeelInfo info : javax.swing.UIManager.getInstalledLookAndFeels()) {
                // Comprueba si el nombre del aspecto es "Nimbus"
                if ("Nimbus".equals(info.getName())) {
                // Establece el aspecto Nimbus como el aspecto de la interfaz gráfica
       ...
       /* Crear y mostrar el formulario */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
         // Crear y mostrar el formulario LISTA
